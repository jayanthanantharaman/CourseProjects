 ...
 *
 */
public class ResourceRespVO extends BaseResponseVO {

	private static final long serialVersionUID = -8891688618411915733L;
	...
	/**
	 * @return the peachResource
	 */
	public Resource getResource() {
		return resource;
	}
	/**
	 * @param peachResource the peachResource to set
	 */
